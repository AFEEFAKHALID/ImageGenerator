...
const Header = () => {
  ...
  return (
    ...
    <motion.button onClick={onClickHandler} className='sm:text-lg text text-white bg-black w-auto mt-8 px-12 py-2.5 flex item-center gap-2 rounded-full'
    whileHover={{ scale: 1.05 }}
    whileTap={{scale: 0.95 }}
    initial={{ opacity: 0 }}
    animate={{ opacity: 1 }}
    transition={{ deafult: { duration: 0.5 }, opacity: {delay: 0.8, duration:1}}}
    >
      Generate Images
